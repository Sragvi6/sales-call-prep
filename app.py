...
def generate_prep():
    ...
    if is_rate_limited(client_ip):
        ...
        return jsonify({"error": "Rate limit exceeded. Maximum of 10 requests per hour are allowed."}), 429
    ...
    if contains_prompt_injection(company_name):
        logger.warning(f"Prompt injection attempt from IP: {client_ip}")
    ...
    if cached_result:
        logger.info(f"Serving cached report for: {company_name}")
        response_data = dict(cached_result)
        response_data["cached"] = True
        return jsonify(response_data)

    logger.info(f"Generating sales prep brief for: {company_name}")
    ...
    {{
        ...
        "recent_news": [
            {{"title": "Headline or description of recent news/event", "summary": "Short explanation of the event and why it is relevant for a sales introduction."}},
            {{"title": "Headline or description of recent news/event", "summary": "Short explanation of the event and why it is relevant for a sales introduction."}},
            {{"title": "Headline or description of recent news/event", "summary": "Short explanation of the event and why it is relevant for a sales introduction."}}
        ],
        "pain_points": [
            {{"issue": "Specific business or operational challenge", "impact": "The impact of this issue on their business growth or efficiency", "solution_angle": "How a modern software/consulting solution could address this"}},
            {{"issue": "Specific business or operational challenge", "impact": "The impact of this issue on their business growth or efficiency", "solution_angle": "How a modern software/consulting solution could address this"}},
            {{"issue": "Specific business or operational challenge", "impact": "The impact of this issue on their business growth or efficiency", "solution_angle": "How a modern software/consulting solution could address this"}}
        ],
        "discovery_questions": [
            {{"question": "Strategic open-ended question to ask key decision makers", "intent": "What specific business intelligence or gap we want to uncover"}},
            {{"question": "Strategic open-ended question to ask key decision makers", "intent": "What specific business intelligence or gap we want to uncover"}},
            {{"question": "Strategic open-ended question to ask key decision makers", "intent": "What specific business intelligence or gap we want to uncover"}},
            {{"question": "Strategic open-ended question to ask key decision makers", "intent": "What specific business intelligence or gap we want to uncover"}}
        ],
        "key_people": [
            {{"name": "Full name or representative role title", "role": "Exact role/title at the company", "focus": "Their primary performance goals and how to build rapport."}},
            {{"name": "Full name or representative role title", "role": "Exact role/title at the company", "focus": "Their primary performance goals and how to build rapport."}},
            {{"name": "Full name or representative role title", "role": "Exact role/title at the company", "focus": "Their primary performance goals and how to build rapport."}}
        ]
    }}

    Important: Only analyze real companies. Provide realistic, actionable, industry-specific information for {company_name}. Do not use generic statements.
    """
